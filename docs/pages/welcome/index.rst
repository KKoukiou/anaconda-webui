...
First, select your preferred language in the left column, and then select your locale (region) from the right column. You can use the search field to find your language instead of looking for it in the full list of available languages.
